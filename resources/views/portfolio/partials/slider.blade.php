    ...
    <div class="hero">
        <div class="tp-banner-container">
          <div class="tp-banner">
            <ul>
                <!-- SLIDE 1 -->
                <li data-transition="fade" data-slotamount="7" data-masterspeed="2000" data-thumb="img/backgrounds/bg-home-fullscreen.jpg" data-delay="10000"  data-saveperformance="on" data-title="Soy Matias Candia">
                  ...
                  <div class="tp-caption sft"
                      ...
                      <h2 class="home-heading op-1">Soy Matias Candia</h2>
                  </div>
                  <!-- Home Subheading -->
                  <div class="tp-caption home-subheading sft "
                      ...
                      data-endspeed="300"
                      style="z-index: 4; max-width: auto; max-height: auto; white-space:normal;">
                      <div class="op-1">ANALISTA DE SISTEMAS | ESTRATEGA DIGITAL</div>
                  </div>
                  <!-- Home Button -->
                  <div class="tp-caption home-button sft fadeout"
                      ...
                      data-endspeed="300"
                      style="z-index: 4; max-width: auto; max-height: auto; white-space:normal;">
                      <div class="op-1"><a href="#contact" class="btn btn-primary btn-scroll">CONTRÁTAME</a></div>
                  </div>
